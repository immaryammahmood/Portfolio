    ...
    >
      <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
        ...
        >
          <span>
            Hi, I am 
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500 mt10">
              {" "}
              Maryam {" "}
            </span>
            <span className="text-transparent bg-clip-text bg-gradient-to-r to-purple-500 from-cyan-500 mt10">
              {" "}
              Mahmood {" "}
            </span>
